@extends('layouts.app')
	...
	@section('footer')
		<script>
			$('.accommModal').css({'display' : 'block'});
			
			$('body').on('click', '.accommModal span', function() {
				$('.accommModal').css({'display' : 'none'});
			});
		</script>
	@endsection
	...
	@section('about_us')
		...
		<div class="w3-modal accommModal">
			<div class="w3-modal-content w3-animate-zoom">
				<span class="w3-button w3-display-topright fa fa-close"></span>
				<div class="">
					<h2 class="w3-center w3-padding" style="background: darkred; color: whitesmoke;">Room Block</h2>
				</div>
				<div class="">
					<h2 class="w3-center" style="margin-bottom:2px;">There is a block of rooms reserved for a discounted rate of $119.00 a night at the hotel listed below.</h2>
					<p class="w3-center" style="color:darkred;">**Block Is Under The Clark and Jackson Wedding Party**</p>
				</div>
				<div class="col s12 offset-m4 m4 l4 w3-padding">
					<h2 class="w3-center w3-padding" style="margin:5px; padding-bottom:0px !important;">Wingate by Wyndham Hotel</h2>
					<h3 class="w3-center" style="margin:5px;"><i>(856) 627-1000</i></h3>
					<h4 class="w3-center" style="margin:5px;"><a href="http://www.wingatehotels.com" target="_blank" class="">www.wingatehotels.com</a></h4>
					<h5 class="w3-center" style="margin:5px;">(4.5 miles)</h5>
				</div>
			</div>
		</div>
