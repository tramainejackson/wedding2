...
@section('about_us')
	...
	<div class="w3-container w3-padding-64" id="us" style="color:#fff;background: linear-gradient(#ffb07c, #ffb07c, #c0fa8b);">
	  <div class="w3-content">
		...
		<div class="hisStory w3-padding-large w3-border w3-hide w3-margin" id="his_story" style="background: radial-gradient(circle, transparent 89%, gray, blue); position:relative;">
			<div class="bgrdShadow"></div>
			<div class="" style="position:relative;">
				<i class="" style="w3-border">It she said it, I second it.</i>
			</div>
		</div>
		<div class="herStory w3-padding-large w3-border w3-hide w3-margin" id="her_story" style="background: radial-gradient(circle, transparent 89%, gray, red); position:relative;">
			<div class="bgrdShadow"></div>
			<div class="" style="position:relative;">
...
@section('wedding_information')
	...
	<div class="w3-display-container bgimg2 w3-hide-small">
	  <div class="w3-display-middle w3-text-white w3-center">
		...
		<h2>Are you invited</h2>
		<h2>Of course..</h2>
	  </div>
	</div>
	
	<!-- Wedding information content -->
	<div class="w3-container w3-padding-64 w3-center" id="wedding" style="color:#000;background-color:#c0fa8b">
...
@section('rsvp_information')
	<!-- RSVP section -->
	<div class="w3-container w3-padding-64 w3-center w3-wide" id="rsvp" style="color:#fff;background: linear-gradient(#c0fa8b, #ffb07c, #ffb07c);">
