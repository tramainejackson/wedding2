...
$(document).ready(function () {
	...
	var options = [{ selector: '.scrollfire0', offset: 250, callback: function callback(el) {
			$(el).fadeTo("slow", 1);
		} }, { selector: '.scrollfire2', offset: 250, callback: function callback(el) {
			$(el).fadeTo("slow", 1);
		} }, { selector: '.scrollfire4', offset: 250, callback: function callback(el) {
			$(el).fadeTo("slow", 1);
		} }, { selector: '.scrollfire6', offset: 250, callback: function callback(el) {
			$(el).fadeTo("slow", 1);
		} }, { selector: '.scrollfire8', offset: 250, callback: function callback(el) {
			$(el).fadeTo("slow", 1);
		} }, { selector: '.scrollfire10', offset: 250, callback: function callback(el) {
			$(el).fadeTo("slow", 1);
		} }, { selector: '.scrollfire12', offset: 250, callback: function callback(el) {
			$(el).fadeTo("slow", 1);
		} }, { selector: '.scrollfire14', offset: 250, callback: function callback(el) {
			$(el).fadeTo("slow", 1);
		} }, { selector: '.scrollfire16', offset: 250, callback: function callback(el) {
			$(el).fadeTo("slow", 1);
		} }, { selector: '.guestList', offset: 0, callback: function callback(el) {
